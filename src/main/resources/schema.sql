...
-- 2. Users Table (Stores Admin and Employee credentials & role)
...
-- 3. Vendors Table (Stores supplier/vendor details)
...
-- 4. Products Table (Stores inventory items & low-stock alert thresholds)
...
-- 5. Sales Table (Stores main billing header information)
...
-- 6. Sale Items Table (Stores individual line items billed in a sale)
...
INSERT IGNORE INTO vendors (vendor_id, name, contact_person, phone, email, address)
VALUES 
(1, 'Annapurna Oils & Foods', 'Rajesh Kumar', '9876543210', 'contact@annapurnaoils.com', '123 Market Street, Block A'),
(2, 'Sri Lakshmi Oil Distributors', 'Venkat Raman', '9123456789', 'orders@srilakshmioil.com', '45 Industrial Estate, Phase II'),
(3, 'Southern Edible Oils', 'Priya Sharma', '9443322110', 'sales@southernoils.in', '78 Harvest Road');

-- Insert Sample Products
INSERT IGNORE INTO products (barcode, name, category, price, cost_price, quantity, min_stock_level, vendor_id)
VALUES 
